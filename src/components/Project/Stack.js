  ...
  return (
    <div className="stacks">
      <p className="stacks__text">
        I have honed my expertise in various languages, frameworks, and tools
        throughout my front-end training.
        <br />
        <p className="stacks__text">
        ...
        proficiency, allowing me to create efficient web applications.
      </p>
    </div>
  );
};
